        ...
        <div class="hidden w-full md:block md:w-auto py-2" id="navbar-default">
            <ul
                        ...
                        <ul class="py-2 text-sm text-gray-700 dark:text-gray-200"
                            ...
                            <li>
                              <form method="POST" action="{{ route('logout') }}">
                                ...
                                <li class="">
                                    <button type="submit"
                                        class="block w-full px-4 py-2 text-lg hover:bg-slate-300 hover:text-dark dark:hover:bg-gray-500 dark:hover:text-white"
                ...
                @else
                    <li>
                        <a href="{{ route('login') }}"
                            class="block py-2 pl-3 pr-4 text-lg text-gray-700 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-gray-400 md:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent">Login</a>
                    </li>
                    <li>
                        <a href="{{ route('register') }}"
                            class="block py-2 pl-3 pr-4 text-lg text-gray-700 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-gray-400 md:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent">Register</a>
                    </li>
                @endif
            </ul>
        </div>
